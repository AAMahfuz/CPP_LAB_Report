...
int main()
{
	...
	{
        new Student("Salam","20-6-1996",department,"1001"),
        new Student("Borkot","13-3-1998",department,"1002"),
        new Student("Zobbar","21-11-1996",department,"1003"),
        new Student("Shofiul","05-07-1997",department,"1004")
    };

	Sellsman sells_person("Abdullah Al Mahfuz","13-03-1985",1);
	sells_person.view_sellsman();
	Login *login_data[2]={
	new Login("Awal","111"),
	new Login("Kuddus","222")
    };

    Faculty *faculty_member[2]=
    {
        new Faculty("Professor","Kamal Ahmed",department,login_data[0]),
        new Faculty("Lecturer","Foysal Islam",department,login_data[1])
    };
