...
int main()
{
    ...
    {
        new Student("Salam",20,3.52,45),
        new Student("Rafiq",23,3.91,110),
        new Student("Borkot",21,3.45,150),
        new Student("Ariyan",20,3.26,310),
        new Student("Jobbar",23,3.28,250),
        new Student("Rahim",21,3.88,100),
        new Student("Karim",22,3.63,200),
        new Student("Mahfuz",22,3.27,99)
    };
