...
int main()
{
    ...
    {
        new Student("Rahim","20-6-1996",department,"1001"),
        new Student("Karim","13-3-1998",department,"1002"),
        new Student("Khaleq","21-11-1996",department,"1003"),
        new Student("Atiq","05-07-1997",department,"1004")
    };

    Sellsman sells_person("Mahfuj","13-03-1985",1);
    ...
    {
        new Faculty("Professor","Abdul Lotif",department,login_data[0]),
        new Faculty("Lecturer","Anisul Islam",department,login_data[1])
    };
    for(int i=0;i<3;i++)
